...
stable and may change between versions."
  ...
  - (Optional) `include_blended_background_colors`: Whether to include blended background colors in the snapshot (default: false).
  Blended background color is achieved by blending background colors of all elements
  that overlap with the current element.
  - (Optional) `include_text_color_opacities`: Whether to include text color opacity in the snapshot (default: false).
